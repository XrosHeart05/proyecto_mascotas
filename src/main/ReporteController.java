...
public class ReporteController {
    ...
    public void actualizarReporte(Reporte _reporte, int accion) {
        switch (accion) {
            ...
            // Tipo de reporte
            case 2:
                System.out.println("El tipo de reporte actual es:" + _reporte.getTipoReporte());
            ...
            // Especie
            case 4:
                TipoEspecieEnum tipoEsp = InputController.inputEspecie();
                _reporte.setEspecie(tipoEsp);
                break;
    ...
    /**
     * Función que indica cuales fechas cumplen con 7 días de diferencia Para
     * esta función se requirio información de la siguiente pagina web:
     * Referencia Bibliográfica Labex.io. Recuperado el 28 de septiembre de 2025
