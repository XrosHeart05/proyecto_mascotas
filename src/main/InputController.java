...
public class InputController {
    ...
    /**
     * La función valida que la fecha que digite el usuario es correcta en
     * formato y que sea real Para esta función se requirió información de la
     * siguiente página Referencia Bibliográfica: Alarcón, J.(08/2023) Cómo
     * validar fechas en Java. campusMVP.es.
    ...
    public static TipoEspecieEnum inputEspecie() {
        ...
        while (true) {
            ...
            if (!especie.equals("DOG") && !especie.equals("CAT")) {
                ...
                if (especie.equals("CAT")) {
                    return TipoEspecieEnum.CAT;
                } else{
                    return TipoEspecieEnum.DOG;
                }
            }
        }
    }
